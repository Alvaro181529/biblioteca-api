...
export class Initial1728511613989 implements MigrationInterface {
    name = 'Initial1728511613989'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "books" ("id" SERIAL NOT NULL, "book_imagen" character varying, "book_document" character varying, "book_inventory" character(15) NOT NULL, "book_isbn" character varying, "book_title_original" character varying NOT NULL, "book_title_parallel" character varying, "book_observation" text, "book_location" character varying, "book_acquisition_date" date, "book_price_type" character(10), "book_original_price" numeric(10,2) DEFAULT '0', "book_price_in_bolivianos" numeric(10,2) DEFAULT '0', "book_language" character varying, "book_type" character varying, "book_description" text, "book_condition" "public"."books_book_condition_enum" NOT NULL DEFAULT 'BUENO', "book_quantity" integer NOT NULL, "book_includes" text, "book_loan" integer NOT NULL DEFAULT '0', "book_create_at" TIMESTAMP NOT NULL DEFAULT now(), "book_update_at" TIMESTAMP DEFAULT now(), CONSTRAINT "PK_f3f2f25a099d24e12545b70b022" PRIMARY KEY ("id"))`);
